"""Tests for the multi-provider model router's failover contract (L4L0 original)."""
...
def _router(*providers: _FakeProvider, chain: tuple[str, ...]) -> ModelRouter:
    return ModelRouter(providers={p.name: p for p in providers}, routes={"reasoning": chain})
