...
parser = argparse.ArgumentParser(
    description="Web Socket Harness: Use traditional tools to assess web sockets"
)
parser.add_argument("-u", "--url", help="The remote WebSocket URL to target.", required=True)
parser.add_argument(
    "-m",
    "--message",
    help="A file that contains the WebSocket message template to send. Please place [FUZZ] where injection is desired.",
    required=True,
)
