...
import string
import sys
from builtins import hex, oct, range, str
from io import open
from random import *
...
def convertIP2EnclosedAlphanumericsValue():
    ...
    for x in range(0, 4):
        if (
            len(IPAddressParts4EnclosedAlphanumerics[x]) == 3
            and (
                int(
            ...
            returnEnclosedAlphanumericsIPAddress = (
                returnEnclosedAlphanumericsIPAddress
                + plain2EnclosedAlphanumericsChar(IPAddressParts4EnclosedAlphanumerics[x][2])
            )
            if x <= 2:
                returnEnclosedAlphanumericsIPAddress = (
            ...
            returnEnclosedAlphanumericsIPAddress = (
                returnEnclosedAlphanumericsIPAddress
                + plain2EnclosedAlphanumericsChar(IPAddressParts4EnclosedAlphanumerics[x][0])
            )
            if len(IPAddressParts4EnclosedAlphanumerics[x]) >= 2:
                returnEnclosedAlphanumericsIPAddress = (
                    returnEnclosedAlphanumericsIPAddress
                    + plain2EnclosedAlphanumericsChar(IPAddressParts4EnclosedAlphanumerics[x][1])
                )
...
if len(sys.argv) < 4 or len(sys.argv) >= 6:
    print(
        "\nUsage: python "
        + sys.argv[0]
        + " IP PORT WhiteListedDomain EXPORT(optional)\nUsage: python "
        + sys.argv[0]
        + " 169.254.169.254 80 www.google.com\nUsage: python "
        + sys.argv[0]
        + " 169.254.169.254 80 www.google.com export"
    )
    exit(1)
...
if EXPORTRESULTS == "export":
    FILENAME = (
        "export-" + arg1 + "-" + str(datetime.datetime.now().strftime("%H-%M-%d-%m-%Y")) + ".txt"
    )
    ...
    print(
        "\nUsage: python "
        + sys.argv[0]
        + " IP WhiteListedDomain EXPORT(optional)\nUsage: python "
        + sys.argv[0]
        + " 169.254.169.254 80 www.google.com\nUsage: python "
        + sys.argv[0]
        + " 169.254.169.254 80 www.google.com export"
...
print(
    bluecolor,
    "Dotted hexadecimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    bluecolor,
    "Dotless hexadecimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
IP2 = (
    HEX_SINGLE(ipFrag3, "yes")
    + HEX_SINGLE(ipFrag2, "no")
    + HEX_SINGLE(ipFrag1, "no")
    + HEX_SINGLE(ipFrag0, "no")
)
...
IP3 = str(
    DECIMAL_SINGLE(ipFrag3, 3)
    + DECIMAL_SINGLE(ipFrag2, 2)
    + DECIMAL_SINGLE(ipFrag1, 1)
    + DECIMAL_SINGLE(ipFrag0, 0)
)
...
print(
    bluecolor,
    "Dotted decimal with overflow(256) IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
IP4 = (
    DEC_OVERFLOW_SINGLE(ipFrag3)
    + "."
    + DEC_OVERFLOW_SINGLE(ipFrag2)
    + "."
    + DEC_OVERFLOW_SINGLE(ipFrag1)
    + "."
    + DEC_OVERFLOW_SINGLE(ipFrag0)
)
...
print(
    bluecolor,
    "Dotted octal with padding IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    bluecolor,
    "IPv6 compact version IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    bluecolor,
    "IPv6 mapped version IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    bluecolor,
    "Dotted hexadecimal + Dotted octal + Dotless decimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
IP9 = (
    ...
    + OCT_SINGLE(ipFrag2)
    + "."
    + str(DECIMAL_SINGLE(ipFrag1, 1) + DECIMAL_SINGLE(ipFrag0, 0))
)
...
print(
    bluecolor,
    "Dotted hexadecimal + Dotless decimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
IP10 = (
    HEX_SINGLE(ipFrag3, "yes")
    + "."
    + str(DECIMAL_SINGLE(ipFrag2, 2) + DECIMAL_SINGLE(ipFrag1, 1) + DECIMAL_SINGLE(ipFrag0, 0))
)
...
print(
    bluecolor,
    "Dotted octal with padding + Dotless decimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    bluecolor,
    "Dotted octal with padding + Dotted hexadecimal + Dotless decimal IP Address of:",
    resetcolor,
    yellowcolor,
    " http://",
    arg1,
...
print(
    ...
    yellowcolor,
    "http://",
    convertIP2EnclosedAlphanumericsValue(),
    resetcolor,
    "        -> ",
    yellowcolor,
    "http://",
